...
import com.vlad.kuzhyr.passengerservice.utility.constant.PassengerRequestConstant;
...
public record PassengerRequest(
        ...
        @Pattern(regexp = PassengerRequestConstant.PHONE_REG_XP, message = "Phone not a valid")
        String phone
