...
ALTER TABLE rating ADD COLUMN ride_info_id BIGINT;

ALTER TABLE rating
ADD CONSTRAINT fk_rating_ride_info FOREIGN KEY (ride_info_id) REFERENCES ride_info(ride_info_id) ON DELETE CASCADE;

ALTER TABLE rating DROP COLUMN driver_id;
ALTER TABLE rating DROP COLUMN ride_id;
ALTER TABLE rating DROP COLUMN passenger_id;
